        ...
        return (
            <View style={{
                ...
                <TouchableOpacity
                    ...
                    <Image style={{width: 20, height: 20, marginLeft: 20, alignSelf:'center'}}
                ...
                <View style={{width:width-80,height:this.props.line?0:1,backgroundColor:'#edf0f0', alignSelf:'flex-end',justifyContent:'flex-end'}}/>
            </View>
        );
    }
}
